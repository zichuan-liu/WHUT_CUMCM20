...
\begin{figure}[H]
	\centering
	\subfigure{\includegraphics[height=8cm,width=7.5cm]{figures/1.png}}
	\subfigure{\includegraphics[height=8cm,width=7.5cm]{figures/2.png}}
\end{figure}	
\begin{figure}[H]	
	\centering
	\subfigure{\includegraphics[height=8cm,width=7.5cm]{figures/3.png}}
	\subfigure{\includegraphics[height=8cm,width=7.5cm]{figures/4.png}}
	\caption{各个小车的运输细节图}
	\label{fisg}
\end{figure}
  ...
  %933.200000000000	826.200000000000	794.600000000000	806.500000000000	783.800000000000	800.700000000000	818.200000000000	840.200000000000
  	\begin{table}[H]
	\setstretch{1.5}  %设置表的行间距
	\centering		
...
\end{table}
    ...
    %[[0, 12, 11, 0], [0, 15, 16, 0], [0, 5, 2, 0], [0, 14, 19, 13, 0], [0, 4, 6, 0], [0, 18, 0], [0, 17, 10, 0], [0, 3, 8, 0], [0, 7, 0], [0, 9, 1, 0]]
    
    %3.3，3.6，2.85，4，2.5，1.4，3.6，4.8，1.2，3.9
    ...
    \begin{figure}[H]	
    	\centering
    	\subfigure[4吨运输车]{\includegraphics[height=8cm,width=7.5cm]{figures/444.png}}
    	\subfigure[6吨运输车]{\includegraphics[height=8cm,width=7.5cm]{figures/666.png}}
    	\caption{各种小车的运输细节图}
    	\label{fissssg}
    \end{figure}
  \section{模型的评价}
